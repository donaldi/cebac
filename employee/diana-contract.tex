...
\title{%
  Employee Contract \\
  COMANN EACHDRAIDH SGÌRE A' BHAC SCIO (SC049033)\\
...
\begin{enumerate}[label=\alph*)]
  \item \textbf{COMANN EACHDRAIDH SGÌRE A' BHAC SCIO (SC049033)}, an association whose registered office is at 
Heritage Centre, School Road, Vatisker Isle of Lewis HS2 0JY (hereinafter referred to as 
``the Employer''), and

\item \textbf{DIANA MACPHAIL} (hereinafter referred to as ``you'').
\end{enumerate}
...
\begin{legal}
  ...
  \item Your line manager shall be CEBac Chairperson or person designated by Chairperson in writing.
  \end{legal}
\end{legal}
...
\begin{legal}
  \item Your period of continuous employment with us begins on \textbf{1 September 2026}.
  \item No employment with a previous employer counts as part of your period of
  continuous employment.
  \item Your employment is for a fixed term and will terminate on \textbf{31 August 2027}.
...
\begin{legal}
\item Your normal working hours are 14 hours per week (0.4 of a full-time equivalent post, a
full-time week for this purpose being 35 hours). You will normally work as follows:
\begin{itemize}
\item Monday: 9am--3pm, including an unpaid lunch break of 1 hour (12pm--1pm), giving 5 paid hours;
\item Tuesday: 9am--3pm, including an unpaid lunch break of 1 hour (12pm--1pm), giving 5 paid hours;
\item Friday: 9am--1pm, giving 4 paid hours.
\end{itemize}
The days and times on which these hours are worked will be agreed between you and the Company
from time to time, having regard to the needs of the business and your availability.
...
normal working hours, however you will be entitled to Time off in Lieu (TOIL) for these 
hours.
\end{legal}


\item \addsubsec{Place of work}
You will be expected to work from the Employer's office (the Heritage Centre/Cabin). Working
from any other location will only be permitted with your line manager's authorisation.

\item \addsubsec{Remuneration}
\begin{legal}
\item Your salary will be £25,396.80 per annum \textit{pro rata} for a full-time equivalent
35-hour week (equivalent to £10,158.72 per annum for working 14 hours a week, i.e. 0.4 FTE),
plus pension contribution, to be paid monthly---normally on the last weekday of every month.
This rate is reviewed to ensure it continues to meet or exceed the real Living Wage
as set by the Living Wage Foundation in force at the time of payment. Payment will be made 
by direct credit transfer 
to a bank or building society account nominated by you. You will not be entitled to overtime
payment for hours worked outside your normal weekly hours (as specified above).
...
\begin{legal}
\item You are entitled to 28 days’ holiday per complete calendar year (including bank and 
public holidays) on a pro rata basis for a full-time equivalent 35-hour week. For your 
14-hour working week (0.4 FTE), this equates to 79 hours’ holiday per calendar year
(equivalent to 11.2 days at your normal 7-hour working day), expressed in hours to
avoid rounding difficulties arising from your part-time working pattern.

If a bank or public holiday falls on a day that you do not normally work, no additional time 
off will be given. Conversely, if a bank or public holiday falls on one of your normal 
working days, it will be counted as part of your holiday entitlement. Special bank holidays, 
which may be given at the Employer’s discretion, are not included in this allowance. 
...
\item You are entitled to Statutory Sick Pay (SSP) from the first qualifying day of any
period of sickness absence, provided that you have met the requirements above. For the
purposes of the SSP scheme the ‘qualifying days’ are the days you are normally required
to work. There is no contractual right to payment in respect of periods of absence due
to sickness or incapacity beyond SSP. Any such additional payments are at the
