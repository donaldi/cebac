...
\item \textbf{CAITRIANA NICHOLSON} (hereinafter referred to as ``you'').
\end{enumerate}
...
\begin{legal}
\item Your normal working hours are 28 hours per week (0.8 of a full-time equivalent post, a
full-time week for this purpose being 35 hours). You will normally work on \textbf{Monday to
Thursday}, 9am to 5pm each day. This 8-hour span includes an unpaid lunch break of 1
hour, giving 7 paid working hours per day. The days and times on which these hours are
worked will be agreed between you and the Company from time to time, having regard to the
needs of the business and your availability.
...
35-hour week (equivalent to £20,317.44 per annum for working 28 hours a week, i.e. 0.8 FTE),
plus pension contribution, to be paid monthly---normally on the last weekday of every month.
This rate is reviewed to ensure it continues to meet or exceed the real Living Wage, as set by 
the Living Wage Foundation, in force at the time of payment. Payment will be made by direct credit transfer 
...
30-hour working week (0.8 FTE), this equates to 157 hours’ holiday per calendar year
(equivalent to 22.4 days at your normal 7-hour working day), expressed in hours to
