...
\item \textbf{CAITRIANA [SURNAME]} (hereinafter referred to as ``you'').
\end{enumerate}
...
\begin{legal}
  ...
  \item Your employment is for a fixed term and will terminate on \textbf{[END DATE]}.
...
\begin{legal}
\item Your normal working hours are 30 hours per week (0.8 of a full-time equivalent post, a
full-time week for this purpose being 37.5 hours). You will normally work on \textbf{Monday to
Thursday}, 9am to 5pm each day. This 8-hour span includes an unpaid lunch break of 30
minutes, giving 7.5 paid working hours per day. The days and times on which these hours are
...
\begin{legal}
\item Your salary will be £25,000 per annum \textit{pro rata} for a full-time equivalent
37.5-hour week (equivalent to £20,000 per annum for working 30 hours a week, i.e. 0.8 FTE),
plus pension contribution, to be paid monthly---normally on the last weekday of every month.
This rate is reviewed to ensure it continues to meet or exceed the National Living Wage
in force at the time of payment. Payment will be made by direct credit transfer 
...
public holidays) on a pro rata basis for a full-time equivalent 37.5-hour week. For your 
30-hour working week (0.8 FTE), this equates to 168 hours’ holiday per calendar year
(equivalent to 22.4 days at your normal 7.5-hour working day), expressed in hours to
